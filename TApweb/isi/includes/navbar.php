		...
		<div class="container">
			...
			<div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
				<ul class="nav navbar-nav">
					...
					<li <?php if($_GET['menu'] == 'profil'){ echo 'class="active"'; } ?>><a href="profil.html">Profil</a></li>
					<li <?php if($_GET['menu'] == 'Bukutamu'){ echo 'class="active"'; } ?>><a href="bukutamu.php">Buku tamu</a></li>
				</ul>
			</div>
		</div>
	</nav>